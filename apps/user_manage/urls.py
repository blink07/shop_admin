...
urlpatterns = [
    url(r'^testSentry$', views.TestSentry.as_view(),name=""),
    ...
    # 角色模块
    url(r'^rolelist/$', views.RolePermissionListView.as_view(), name="获取角色列表"),
    ...
    url(r'roleList/$', views.RoleView.as_view({'get':'list'}) ),
